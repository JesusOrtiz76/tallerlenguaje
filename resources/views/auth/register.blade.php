                        ...
                        <div class="card-body p-5 p-lg-5">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" oninput="toCap(this)" required autocomplete="name" autofocus>
                                    @error('name')
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input id="rfc" type="text" class="form-control @error('rfc') is-invalid @enderror" name="rfc" value="{{ old('rfc') }}" oninput="toMay(this)" required autocomplete="rfc" autofocus>
                                    @error('rfc')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-outline mb-4">
                                    <label for="email">{{ __('Email Address') }}</label>
                                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" oninput="toMin(this)" required autocomplete="email">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
